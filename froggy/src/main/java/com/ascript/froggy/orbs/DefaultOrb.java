package com.ascript.froggy.orbs;
...
public class DefaultOrb extends CustomOrb {
    ...
    public static final String ORB_ID = FroggyMod.makeID("DefaultOrb");
    ...
    public DefaultOrb() {
        ...
        super(ORB_ID, orbString.NAME, PASSIVE_AMOUNT, EVOKE_AMOUNT, DESCRIPTIONS[1], DESCRIPTIONS[3], FroggyMod.makeOrbPath("default_orb.png"));
