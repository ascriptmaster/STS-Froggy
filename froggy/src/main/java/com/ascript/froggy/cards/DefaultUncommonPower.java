...
import com.ascript.froggy.actions.UncommonPowerAction;
...
public class DefaultUncommonPower extends AbstractDynamicCard {
    ...
    public static final String ID = FroggyMod.makeID(DefaultUncommonPower.class.getSimpleName());
    public static final String IMG = FroggyMod.makeCardPath("Power.png");
