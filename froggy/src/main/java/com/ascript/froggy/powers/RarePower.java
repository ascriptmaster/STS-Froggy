...
import com.ascript.froggy.cards.DefaultRareAttack;
...
public class RarePower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = FroggyMod.makeID("RarePower");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;

    // We create 2 new textures *Using This Specific Texture Loader* - an 84x84 image and a 32x32 one.
    private static final Texture tex84 = TextureLoader.getTexture("froggyResources/images/powers/placeholder_power84.png");
    private static final Texture tex32 = TextureLoader.getTexture("froggyResources/images/powers/placeholder_power32.png");
