package com.ascript.froggy.relics;
...
import com.ascript.froggy.patches.relics.BottledPlaceholderField;
import com.ascript.froggy.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static com.ascript.froggy.FroggyMod.makeRelicOutlinePath;
import static com.ascript.froggy.FroggyMod.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = FroggyMod.makeID("BottledPlaceholderRelic");
