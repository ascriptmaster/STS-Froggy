package com.ascript.froggy.events;
...
import static com.ascript.froggy.FroggyMod.makeEventPath;

public class IdentityCrisisEvent extends AbstractImageEvent {


    public static final String ID = FroggyMod.makeID("IdentityCrisisEvent");
            ...
            case 0: // While you are on screen number 0 (The starting screen)
                switch (i) {
                    ...
                    case 3: // If you press button the fourth button (Button at index 3), in this case: TOUCH
                        imageEventText.loadImage("froggyResources/images/events/IdentityCrisisEvent2.png"); // Change the shown image
